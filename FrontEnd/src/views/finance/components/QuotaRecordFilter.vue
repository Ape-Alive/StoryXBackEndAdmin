<template>
  <div class="quota-record-filter">
    ...
    <div class="filter-group">
      <label class="filter-label">订单ID</label>
      <el-input
        ...
        class="filter-input"
        style="width: 180px"
        @input="val => handleInput('orderId', val)"
        @clear="handleInputClear('orderId')"
      />
    </div>
    <div class="filter-group">
      <label class="filter-label">流水类型</label>
      <el-select
    ...
    <div class="filter-group">
      <label class="filter-label">请求ID</label>
      <el-input
        ...
        class="filter-input"
        style="width: 180px"
        @input="val => handleInput('requestId', val)"
        @clear="handleInputClear('requestId')"
      />
    </div>
    <div class="filter-group">
