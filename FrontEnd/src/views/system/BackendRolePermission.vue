<template>
  <div class="backend-role-page">
    <div class="page-header">
      <div class="header-left">
        <h1 class="page-title">后台角色权限管理</h1>
        <p class="page-description">管理系统后台角色与菜单、按钮权限绑定。</p>
      </div>
        ...
        <div class="role-card-header">
          ...
          <div class="role-info">
            <div class="role-title-row">
              ...
              <el-tag v-if="role.roleKey === 'super_admin'" size="small" type="danger">全权限</el-tag>
              <el-tag v-else-if="role.isSystem" size="small" type="info">系统内置</el-tag>
            </div>
...
import { deleteBackendRole, getBackendRoles } from '@/api/backendRole'
...
function canDeleteRole(role) {
  return isSuperAdmin.value && role.roleKey !== 'super_admin' && !role.isSystem
}
